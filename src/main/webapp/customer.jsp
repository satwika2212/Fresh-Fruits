        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                 <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="customer.jsp">Home</a>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link" href="customerfruits">Menu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="searchFruit.jsp">Search</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="findByEmail">View Profile</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h3 class="display-4 fw-bold">Customer Portal</h3>
                        ...
                        <a href="customerfruits" class="btn btn-primary btn-lg">Explore Our Fruits</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <img src="./images/customer.jpg" alt="Fresh Fruits" class="img-fluid  home-image">
                </div>
            </div>
        </div>
    </header>
